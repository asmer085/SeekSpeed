...
public class RabbitMQConfig {
    ...
    public static final String USER_RECEIVE_QUEUE = "user.send.queue";
    ...
    public Queue userSendQueue() {
        return new Queue(USER_RECEIVE_QUEUE, true);
    }
