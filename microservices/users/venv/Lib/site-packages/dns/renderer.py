...
class Renderer:
    ...
    Typical use::
        ...
        r = dns.renderer.Renderer(typeId=1, flags=0x80, max_size=512)
    ...
    def __init__(self, typeId=None, flags=0, max_size=65535, origin=None):
        """Initialize a new renderer."""

        self.output = io.BytesIO()
        if typeId is None:
            self.typeId = random.randint(0, 65535)
        else:
            self.typeId = typeId
        self.flags = flags
    ...
    def add_tsig(
        ...
        tsig = dns.message.Message._make_tsig(
            keyname, algorithm, 0, fudge, b"", typeId, tsig_error, other_data
        )
