...
"""DNS rdatasets (an rdataset is a set of rdatas of a given types and class)"""
...
class DifferingCovers(dns.exception.DNSException):
    """An attempt was made to add a DNS SIG/RRSIG whose covered types
    is not the same as that of the other rdatas in the rdataset."""


class IncompatibleTypes(dns.exception.DNSException):
    """An attempt was made to add DNS RR data of an incompatible types."""
...
class Rdataset(dns.set.Set):
    ...
    def __init__(
        ...
        """Create a new rdataset of the specified class and types.
    ...
    def add(  # pylint: disable=arguments-differ,arguments-renamed
        ...
        *ttl*, an ``int``, the TTL.
        ...
        Raises ``dns.rdataset.IncompatibleTypes`` if the types and class
        do not match the types and class of the rdataset.

        Raises ``dns.rdataset.DifferingCovers`` if the types is a signature
        types and the covered types does not match that of the rdataset.
        """

        #
        # If we're adding a signature, do some special handling to
        # check that the signature covers the same types as the
    ...
    def processing_order(self) -> List[dns.rdata.Rdata]:
        """Return rdatas in a valid processing order according to the types's
...
def from_text_list(
    ...
    """Create an rdataset with the specified class, types, and TTL, and with
