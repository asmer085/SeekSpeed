...
import copy
import encodings.idna  # types: ignore
import functools
import struct
...
class BadLabelType(dns.exception.FormError):
    """The label types in DNS name wire format is unknown."""
...
def from_wire_parser(parser: "dns.wire.Parser") -> Name:
    ...
    *parser* is a dns.wire.Parser.
    ...
    Raises ``dns.name.BadLabelType`` if an invalid label types was encountered.
