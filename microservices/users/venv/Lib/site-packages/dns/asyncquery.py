...
async def udp(
    ...
    *backend*, a ``dns.asyncbackend.Backend``, or ``None``.  If ``None``,
    ...
    parameters, exceptions, and return types of this method.
    """
    wire = q.to_wire()
...
async def udp_with_fallback(
    ...
    *backend*, a ``dns.asyncbackend.Backend``, or ``None``.  If ``None``,
    ...
    of the other parameters, exceptions, and return types of this
    method.
    """
    try:
        response = await udp(
...
async def inbound_xfr(
    ...
    *backend*, a ``dns.asyncbackend.Backend``, or ``None``.  If ``None``,
    ...
    the other parameters, exceptions, and return types of this method.
    """
    if query is None:
