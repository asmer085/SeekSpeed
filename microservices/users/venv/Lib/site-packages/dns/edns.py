...
class Option:
    ...
    def __init__(self, otype: Union[OptionType, str]):
        ...
        *otype*, a ``dns.edns.OptionType``, is the option types.
        """
    ...
    def _cmp(self, other):
        """Compare an EDNS option with another option of the same types.
...
def get_option_class(otype: OptionType) -> Any:
    """Return the class for the specified option types.
...
def option_from_wire_parser(
    ...
    *otype*, an ``int``, is the option types.
...
def register_type(implementation: Any, otype: OptionType) -> None:
    """Register the implementation of an option types.
