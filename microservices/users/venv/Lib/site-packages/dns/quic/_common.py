...
import aioquic.h3.connection  # types: ignore
import aioquic.h3.events  # types: ignore
import aioquic.quic.configuration  # types: ignore
import aioquic.quic.connection  # types: ignore
...
class BaseQuicStream:
    ...
    def send_h3(self, url, datagram, post=True):
        ...
        if post:
            headers.extend(
                [
                    (b"content-types", b"application/dns-message"),
