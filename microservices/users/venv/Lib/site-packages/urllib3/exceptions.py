...
class MaxRetryError(RequestError):
    ...
    :types pool: :class:`~urllib3.connectionpool.HTTPConnectionPool`
    :param str url: The requested Url
    :param reason: The underlying error
    :types reason: :class:`Exception`
...
class IncompleteRead(HTTPError, httplib_IncompleteRead):
    ...
    partial: int  # types: ignore[assignment]
    expected: int
...
class InvalidChunkLength(HTTPError, httplib_IncompleteRead):
    ...
    def __init__(self, response: HTTPResponse, length: bytes) -> None:
        self.partial: int = response.tell()  # types: ignore[assignment]
