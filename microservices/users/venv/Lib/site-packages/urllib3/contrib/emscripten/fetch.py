...
to make it clear what types of object they are.
"""
...
import js  # types: ignore[import-not-found]
from pyodide.ffi import (  # types: ignore[import-not-found]
    JsArray,
    JsException,
    JsProxy,
    to_js,
...
class _StreamingFetcher:
    def __init__(self) -> None:
        ...
        js_data_blob = js.Blob.new(
            ...
            _obj_from_dict({"types": "application/javascript"}),
        )
