...
def inject_into_urllib3() -> None:
    ...
    urllib3.connection.HTTPConnection = EmscriptenHTTPConnection  # types: ignore[misc,assignment]
    urllib3.connection.HTTPSConnection = EmscriptenHTTPSConnection  # types: ignore[misc,assignment]
