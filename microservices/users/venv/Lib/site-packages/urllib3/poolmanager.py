...
def _default_key_normalizer(
    key_class: types[PoolKey], request_context: dict[str, typing.Any]
) -> PoolKey:
    """
    ...
    :types  key_class: namedtuple
    :param request_context:
        A dictionary-like object that contain the context for a request.
    :types  request_context: dict
...
class PoolManager(RequestMethods):
    ...
    def _new_pool(
        ...
        """
        pool_cls: types[HTTPConnectionPool] = self.pool_classes_by_scheme[scheme]
    ...
    def connection_from_pool_key(
        ...
        with self.pools.lock:
            ...
            # Make a fresh ConnectionPool of the desired types
...
class ProxyManager(PoolManager):
    ...
    def connection_from_host(
        ...
        return super().connection_from_host(
            self.proxy.host, self.proxy.port, self.proxy.scheme, pool_kwargs=pool_kwargs  # types: ignore[union-attr]
        )
