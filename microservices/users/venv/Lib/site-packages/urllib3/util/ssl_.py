...
def _is_bpo_43522_fixed(
    ...
    if implementation_name == "pypy":
        ...
        return pypy_version_info >= (7, 3, 8)  # types: ignore[operator]
...
try:  # Do we have ssl at all?
    import ssl
    from ssl import (  # types: ignore[assignment]
        CERT_REQUIRED,
    ...
    if HAS_NEVER_CHECK_COMMON_NAME and not _is_has_never_check_common_name_reliable(
        ...
        sys.version_info,
        sys.pypy_version_info if sys.implementation.name == "pypy" else None,  # types: ignore[attr-defined]
    ):
        HAS_NEVER_CHECK_COMMON_NAME = False
    ...
    from .ssltransport import SSLTransport  # types: ignore[assignment]
except ImportError:
    OP_NO_COMPRESSION = 0x20000  # types: ignore[assignment]
    OP_NO_TICKET = 0x4000  # types: ignore[assignment]
    OP_NO_SSLv2 = 0x1000000  # types: ignore[assignment]
    OP_NO_SSLv3 = 0x2000000  # types: ignore[assignment]
    PROTOCOL_SSLv23 = PROTOCOL_TLS = 2  # types: ignore[assignment]
    PROTOCOL_TLS_CLIENT = 16  # types: ignore[assignment]
...
def resolve_cert_reqs(candidate: None | int | str) -> VerifyMode:
    ...
    if isinstance(candidate, str):
        ...
        return res  # types: ignore[no-any-return]

    return candidate  # types: ignore[return-value]
