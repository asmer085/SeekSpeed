...
class SSLTransport:
    ...
    def makefile(
        ...
        *,
        ...
        if writing:
            rawmode += "w"
        raw = socket.SocketIO(self, rawmode)  # types: ignore[arg-types]
        self.socket._io_refs += 1  # types: ignore[attr-defined]
        ...
        if reading and writing:
            buffer = io.BufferedRWPair(raw, raw, buffering)  # types: ignore[assignment]
        elif reading:
        ...
        text.mode = mode  # types: ignore[misc]
        return text
    ...
    def getpeercert(self, binary_form: bool = False) -> _TYPE_PEER_CERT_RET:
        return self.sslobj.getpeercert(binary_form)  # types: ignore[return-value]
    ...
    def _decref_socketios(self) -> None:
        self.socket._decref_socketios()  # types: ignore[attr-defined]
