...
class Url(
    ...
    def __new__(  # types: ignore[no-untyped-def]
        cls,
...
def parse_url(url: str) -> Url:
    ...
    try:
        scheme, authority, path, query, fragment = _URI_RE.match(url).groups()  # types: ignore[union-attr]
        ...
        if authority:
            ...
            auth = auth or None
            host, port = _HOST_PORT_RE.match(host_port).groups()  # types: ignore[union-attr]
