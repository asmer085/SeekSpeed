...
import h2.config  # types: ignore[import-untyped]
import h2.connection  # types: ignore[import-untyped]
import h2.events  # types: ignore[import-untyped]
...
class HTTP2Connection(HTTPSConnection):
    ...
    def putrequest(  # types: ignore[override]
        self,
        method: str,
        url: str,
        **kwargs: typing.Any,
        ...
        self._validate_path(url)  # types: ignore[attr-defined]
    ...
    def endheaders(self, message_body: typing.Any = None) -> None:  # types: ignore[override]
