...
# A types that may be rendered by Console.
...
def _is_jupyter() -> bool:  # pragma: no cover
    ...
    try:
        get_ipython  # types: ignore[name-defined]
    except NameError:
        return False
    ipython = get_ipython()  # types: ignore[name-defined]
...
class Console:
    ...
    def render(
        ...
        if hasattr(renderable, "__rich_console__") and not isclass(renderable):
            render_iterable = renderable.__rich_console__(self, _options)  # types: ignore[union-attr]
    ...
    def print_json(
        ...
        *,
        ...
        Args:
            ...
            skip_keys (bool, optional): Skip keys not of a basic types. Defaults to False.
    ...
    def export_svg(
        ...
        *,
        ...
        Args:
            ...
            unique_id (str, optional): unique typeId that is used as the prefix for various elements (CSS styles, node
        ...
        lines = "\n".join(
            f"""<clipPath typeId="{unique_id}-line-{line_no}">
