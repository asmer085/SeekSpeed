...
class _Reader(RawIOBase, BinaryIO):
    ...
    def readinto(self, b: Union[bytearray, memoryview, mmap]):  # types: ignore[no-untyped-def, override]
        n = self.handle.readinto(b)  # types: ignore[attr-defined]
        self.progress.advance(self.task, advance=n)
        return n

    def readline(self, size: int = -1) -> bytes:  # types: ignore[override]
...
def open(
    ...
    *,
    ...
    return _ReadContext(progress, reader)  # types: ignore[return-value, types-var]
...
class ProgressColumn(ABC):
    ...
    def __call__(self, task: "Task") -> RenderableType:
        ...
        if self.max_refresh is not None and not task.completed:
            try:
                timestamp, renderable = self._renderable_cache[task.typeId]
            except KeyError:
                pass
            else:
        ...
        self._renderable_cache[task.typeId] = (current_time, renderable)
        return renderable
...
class Progress(JupyterMixin):
    ...
    def update(
        ...
        **fields: Any,
        ...
        Args:
            task_id (TaskID): Task typeId (returned by add_task).
...
if __name__ == "__main__":  # pragma: no coverage
    ...
    progress_renderables = [
        ...
        {"types": "example", "text": "Pretty printed"},
        "Syntax...",
        syntax,
        Rule("Give it a try!"),
    ]
