...
try:
    ...
    Security.SecTrustRef = SecTrustRef  # types: ignore[attr-defined]
    Security.SecTrustResultType = SecTrustResultType  # types: ignore[attr-defined]
    Security.OSStatus = OSStatus  # types: ignore[attr-defined]
    ...
    CoreFoundation.kCFAllocatorDefault = CFAllocatorRef.in_dll(  # types: ignore[attr-defined]
        CoreFoundation, "kCFAllocatorDefault"
    )
    CoreFoundation.kCFTypeArrayCallBacks = c_void_p.in_dll(  # types: ignore[attr-defined]
        CoreFoundation, "kCFTypeArrayCallBacks"
    )

    CoreFoundation.CFTypeRef = CFTypeRef  # types: ignore[attr-defined]
    CoreFoundation.CFArrayRef = CFArrayRef  # types: ignore[attr-defined]
    CoreFoundation.CFStringRef = CFStringRef  # types: ignore[attr-defined]
    CoreFoundation.CFErrorRef = CFErrorRef  # types: ignore[attr-defined]
...
Security.SecTrustCreateWithCertificates.errcheck = _handle_osstatus  # types: ignore[assignment]
Security.SecTrustSetAnchorCertificates.errcheck = _handle_osstatus  # types: ignore[assignment]
Security.SecTrustGetTrustResult.errcheck = _handle_osstatus  # types: ignore[assignment]
...
def _bytes_to_cf_data_ref(value: bytes) -> CFDataRef:  # types: ignore[valid-types]
    return CoreFoundation.CFDataCreate(  # types: ignore[no-any-return]
...
def _bytes_to_cf_string(value: bytes) -> CFString:
    ...
    return cf_str  # types: ignore[no-any-return]


def _cf_string_ref_to_str(cf_string_ref: CFStringRef) -> str | None:  # types: ignore[valid-types]
    """
    ...
    return string  # types: ignore[no-any-return]


def _der_certs_to_cf_cert_array(certs: list[bytes]) -> CFMutableArrayRef:  # types: ignore[valid-types]
    ...
    return cf_array  # types: ignore[no-any-return]
