...
import ssl
import typing
from ctypes import WinDLL  # types: ignore
from ctypes import WinError  # types: ignore
from ctypes import (
    POINTER,
    Structure,
    c_char_p,
...
if TYPE_CHECKING:
    PCERT_CHAIN_PARA = pointer[CERT_CHAIN_PARA]  # types: ignore[misc]
else:
...
def _get_and_verify_cert_chain(
    ...
    pChainPara: PCERT_CHAIN_PARA,  # types: ignore[valid-types]
