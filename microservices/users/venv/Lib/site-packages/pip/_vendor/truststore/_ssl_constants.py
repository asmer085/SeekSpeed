...
_truststore_SSLContext_dunder_class: typing.Optional[types]

# This value is the superclass of truststore.SSLContext.
_truststore_SSLContext_super_class: types
...
def _set_ssl_context_verify_mode(
    ...
    _original_super_SSLContext.verify_mode.__set__(ssl_context, verify_mode)  # types: ignore[attr-defined]
