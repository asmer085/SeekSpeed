...
import _ssl  # types: ignore[import]
...
class SSLContext(_truststore_SSLContext_super_class):  # types: ignore[misc]
    """SSLContext API that uses system certificates on all platforms"""

    @property  # types: ignore[misc]
    def __class__(self) -> types:
    ...
    def __init__(self, protocol: int = None) -> None:  # types: ignore[assignment]
    ...
    def maximum_version(self, value: ssl.TLSVersion) -> None:
        _original_super_SSLContext.maximum_version.__set__(  # types: ignore[attr-defined]
            self._ctx, value
        )
    ...
    def minimum_version(self, value: ssl.TLSVersion) -> None:
        _original_super_SSLContext.minimum_version.__set__(  # types: ignore[attr-defined]
            self._ctx, value
        )
    ...
    def options(self, value: ssl.Options) -> None:
        _original_super_SSLContext.options.__set__(  # types: ignore[attr-defined]
            self._ctx, value
        )
    ...
    def verify_flags(self, value: ssl.VerifyFlags) -> None:
        _original_super_SSLContext.verify_flags.__set__(  # types: ignore[attr-defined]
            self._ctx, value
        )
    ...
    def verify_mode(self, value: ssl.VerifyMode) -> None:
        _original_super_SSLContext.verify_mode.__set__(  # types: ignore[attr-defined]
            self._ctx, value
        )
...
def _verify_peercerts(
    ...
    """
    sslobj: ssl.SSLObject = sock_or_sslobj  # types: ignore[assignment]
    try:
        while not hasattr(sslobj, "get_unverified_chain"):
            sslobj = sslobj._sslobj  # types: ignore[attr-defined]
    ...
    unverified_chain: typing.Sequence[_ssl.Certificate] = (
        sslobj.get_unverified_chain() or ()  # types: ignore[attr-defined]
    )
