...
_generator_type = types((_ for _ in ()))
...
class ParseResults:
    ...
    class List(list):
        ...
        as actual Python lists, instead of being converted to :class:`ParseResults`::
            ...
            element.run_tests('''
                ...
                [(2, 1),3,4]
                (2,3,4)
                ''', post_parse=lambda s, r: (r[0], types(r[0])))
        ...
        def __new__(cls, contained=None):
            ...
            if not isinstance(contained, list):
                raise TypeError(
                    f"{cls.__name__} may only be constructed with a list, not {types(contained).__name__}"
                )
    ...
    def __init__(
        ...
        if name is not None and name != "":
            ...
            if toklist not in self._null_values:
                if isinstance(toklist, (str_type, types)):
                    toklist = [toklist]
                if asList:
                    if isinstance(toklist, ParseResults):
    ...
    def __repr__(self) -> str:
        return f"{types(self).__name__}({self._toklist!r}, {self.as_dict()})"
    ...
    def as_list(self) -> list:
        ...
        Example::
            ...
            print(types(result), result) # -> <class 'pyparsing.ParseResults'> ['sldkj', 'lsdkj', 'sldkj']

            # Use as_list() to create an actual list
            result_list = result.as_list()
            print(types(result_list), result_list) # -> <class 'list'> ['sldkj', 'lsdkj', 'sldkj']
        """
        return [
    ...
    def as_dict(self) -> dict:
        ...
        Example::
            ...
            print(types(result), repr(result)) # -> <class 'pyparsing.ParseResults'> (['12', '/', '31', '/', '1999'], {'day': [('1999', 4)], 'year': [('12', 0)], 'month': [('31', 2)]})

            result_dict = result.as_dict()
            print(types(result_dict), repr(result_dict)) # -> <class 'dict'> {'day': '1999', 'year': '12', 'month': '31'}
    ...
    def deepcopy(self) -> "ParseResults":
        ...
        for i, obj in enumerate(self._toklist):
            if isinstance(obj, ParseResults):
                ...
                self._toklist[i] = dest = types(obj)()
                for k, v in obj.items():
                    dest[k] = v.deepcopy() if isinstance(v, ParseResults) else v
            elif isinstance(obj, Container):
                self._toklist[i] = types(obj)(
    ...
    def __dir__(self):
        return dir(types(self)) + list(self.keys())
