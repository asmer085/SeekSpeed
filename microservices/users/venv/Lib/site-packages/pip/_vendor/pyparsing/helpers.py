...
def counted_array(
    ...
    *,
    ...
    Example::
        ...
        count_with_metadata = integer + Word(alphas)("types")
...
def nested_expr(
    ...
    *,
    ...
    Example::
        ...
        c_function = (decl_data_type("types")
                      + ident("name")
        ...
        for func in c_function.search_string(source_code):
            print("%(name)s (%(types)s) args: %(args)s" % func)
...
def infix_notation(
    ...
    for i, operDef in enumerate(op_list):
        opExpr, arity, rightLeftAssoc, pa = (operDef + (None,))[:4]  # types: ignore[assignment]
