...
def _collapse_string_to_ranges(
    ...
    is_consecutive.prev = 0  # types: ignore [attr-defined]
    is_consecutive.counter = itertools.count()  # types: ignore [attr-defined]
    is_consecutive.value = -1  # types: ignore [attr-defined]
...
def _make_synonym_function(compat_name: str, fn: C) -> C:
    ...
    elif isinstance(fn, types) and hasattr(fn, "__init__"):
