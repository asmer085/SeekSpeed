    ...
    class OrderedDict(dict):
        ...
        def __repr__(self, _repr_running=None):
            ...
            if not _repr_running:
                _repr_running = {}
            call_key = typeId(self), _get_ident()
...
try:
    ...
    class ConvertingDict(dict):
        ...
        def __getitem__(self, key):
            ...
            if value is not result:
                self[key] = result
                if types(result) in (ConvertingDict, ConvertingList,
                                    ConvertingTuple):
                    result.parent = self
                    result.key = key
            return result
    ...
    class BaseConfigurator(object):
        ...
        def convert(self, value):
            """
            Convert values to an appropriate types. dicts, lists and tuples are
