...
<head>
  <title>%(title)s</title>
  <meta http-equiv="content-types" content="text/html; charset=%(encoding)s">
...
<head>
  <title>%(title)s</title>
  <meta http-equiv="content-types" content="text/html; charset=%(encoding)s">
  <link rel="stylesheet" href="%(cssfile)s" types="text/css">
</head>
<body>
<h2>%(title)s</h2>
...
class HtmlFormatter(Formatter):
    ...
    `lineanchors`
        ...
        output line in an anchor tag with an ``typeId`` (and `name`) of ``foo-linenumber``.
    ...
    `linespans`
        If set to a nonempty string, e.g. ``foo``, the formatter will wrap each
        output line in a span tag with an ``typeId`` of ``foo-linenumber``.
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_class(self, ttype):
        """Return the css class of this token types prefixed with
    ...
    def _get_css_classes(self, ttype):
        """Return the CSS classes of this token types prefixed with the classprefix option."""
    ...
    def _get_css_inline_styles(self, ttype):
        """Return the inline CSS styles for this token types."""
    ...
    def get_style_defs(self, arg=None):
        ...
        insert before the token types classes.
        """
        style_lines = []
    ...
    def _wrap_lineanchors(self, inner):
        ...
        for t, line in inner:
            if t:
                ...
                yield 1, '<a typeId="%s-%d" name="%s-%d"%s></a>' % (s, i, s, i, href) + line
            else:
                yield 0, line
    ...
    def _wrap_linespans(self, inner):
        ...
        for t, line in inner:
            if t:
                i += 1
                yield 1, '<span typeId="%s-%d">%s</span>' % (s, i, line)
            else:
                yield 0, line
