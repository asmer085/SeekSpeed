...
class Factory:
    ...
    def _make_extras_candidate(
        ...
        *,
        ...
        cache_key = (typeId(base), frozenset(canonicalize_name(e) for e in extras))
        try:
    ...
    def _iter_found_candidates(
        ...
        def _get_installed_candidate() -> Optional[Candidate]:
            ...
            if typeId(candidate) in incompatible_ids:
                return None
            return candidate
    ...
    def find_candidates(
        ...
        # can be made quicker by comparing only the typeId() values.
        incompat_ids = {typeId(c) for c in incompatibilities.get(identifier, ())}
        ...
        return (
            ...
            if typeId(c) not in incompat_ids
