...
class CCompiler:
    ...
    def _fix_compile_args(self, output_dir, macros, include_dirs):
        ...
        Guarantees that the returned values are of the correct types,
    ...
    def _make_out_path(self, output_dir, strip_dir, src_name):
        ...
        try:
            ...
            raise UnknownFileError(
                "unknown file types '{}' (from '{}')".format(ext, src_name)
            )
        if strip_dir:
...
# types for that platform. Keys are interpreted as re match
