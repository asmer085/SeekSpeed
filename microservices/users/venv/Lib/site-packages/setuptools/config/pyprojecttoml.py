...
def load_file(filepath: _Path) -> dict:
    from setuptools.extern import tomli  # types: ignore
...
def validate(config: dict, filepath: _Path) -> bool:
    ...
    if hasattr(trove_classifier, "_disable_download"):
        ...
        trove_classifier._disable_download()  # types: ignore
    ...
    def _obtain_readme(self, dist: "Distribution") -> Optional[Dict[str, str]]:
        ...
        if "readme" in dynamic_cfg:
            return {
                ...
                "content-types": dynamic_cfg["readme"].get("content-types", "text/x-rst"),
            }
