    ...
    def __getattr__(self, attr):
        ...
        try:
            return next(
                ...
                if isinstance(target, ast.Name) and target.typeId == attr
            )
...
def _load_spec(spec: ModuleSpec, module_name: str) -> ModuleType:
    ...
    spec.loader.exec_module(module)  # types: ignore
    return module
...
def find_packages(
    ...
    **kwargs
    ...
    if namespaces:
        ...
        from setuptools.discovery import PackageFinder  # types: ignore
...
def entry_points(text: str, text_source="entry-points") -> Dict[str, dict]:
    ...
    """
    parser = ConfigParser(default_section=None, delimiters=("=",))  # types: ignore
